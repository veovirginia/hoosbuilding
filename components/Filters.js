...
export default function Filters(props) {
    ...
    function setParentStates() {
        ...
        props.setNameFilter(nameFilter);
        props.setFounderFilter(founderFilter);
        props.setFundingFilter(fundingFilter);
        props.setYearFilter(yearFilter);
    }
		...
		<div className={styles.filtersContainer}>
			<div className={styles.filters}>
				...
				<div className={styles.filterGroupLeft}>
					...
					<CustomListbox
						filter={handleYearFilter}
						items={generateJSONOfYears(2000)}
						isFiltering={isFiltering}
					/>
				</div>
			...
			<div
				...
				className={
					isFiltering ? styles.clearFilters : styles.disabledClearFilters
				}
			>
				Clear filters
			</div>
