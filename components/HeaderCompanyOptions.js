...
export default function HeaderCompanyOptions(props) {
    return (
        <div className={styles.companyOptions}>
            ...
            <div className={styles.addCompany} onClick={console.log("add pushed")}>{/*onClick={() => Router.push("/add")}*/}Add a company</div> 
            <div className={styles.updateCompany} onClick={console.log("update pushed")}>Update a company</div>
        </div>
    )
}