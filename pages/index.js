	...
	return (
		<div className={styles.container}>
			...
			<main className={styles.main}>
						...
						<div className={styles.left}>
							...
							<div className={styles.interestedContainer}>
								<div
									...
									onClick={() => Router.push("http://join.vesatuva.org")}
								>
									I'm interested
								</div>
							</div>
				...
				<div className={styles.filters}>
					<Filters
						...
						stages={stages}
						setCategoryFilter={setCF}
						setNameFilter={setNF}
						setFounderFilter={setFounderF}
						setYearFilter={setYF}
						setFundingFilter={setFundingF}
					/>
				</div>
				<CompanySection
			...
			<p className={styles.myFooter}>
				Managed by <a href="https://vesatuva.org">v1 Virginia</a>, Inspired by{" "}
				<a href="https://gsbuilds.co">GSBuilds</a>
			</p>
		</div>
	);
}
